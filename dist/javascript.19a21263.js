...
},{"./..\\svg\\effect-no-move.svg":[["effect-no-move.e6a51026.svg","src/svg/effect-no-move.svg"],"src/svg/effect-no-move.svg"],"./..\\svg\\effect-move1.svg":[["effect-move1.8d0ce205.svg","src/svg/effect-move1.svg"],"src/svg/effect-move1.svg"],"./..\\svg\\effect-move2.svg":[["effect-move2.143040a0.svg","src/svg/effect-move2.svg"],"src/svg/effect-move2.svg"],"./..\\svg\\progress.svg":[["progress.798a5c76.svg","src/svg/progress.svg"],"src/svg/progress.svg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/javascript/icon.js":[function(require,module,exports) {
...
var Player = /*#__PURE__*/function () {
  function Player(node) {
    ...
    this.f1 = function (selector) {
      return _this.root.querySelector(selector);
    };

    this.f2 = function (selector) {
  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      this.f1('.btn-play-pause').onclick = function () {
        if (this.classList.contains('playing')) {
          ...
          var iconPause1 = self.f1(' .effect1');
          iconPause1.style.animationPlayState = 'paused';
          var iconPause2 = self.f1(' .effect2');
          iconPause2.style.animationPlayState = 'paused';
          var iconPause3 = self.f1(' .effect3');
          ...
          var _iconPause = self.f1(' .effect1');

          _iconPause.style.animationPlayState = 'running';

          var _iconPause2 = self.f1(' .effect2');

          _iconPause2.style.animationPlayState = 'running';

          var _iconPause3 = self.f1(' .effect3');

          _iconPause3.style.animationPlayState = 'running';
        }
      };
      ...
      var swiper = new _swiper.default(this.f1('.panels'));
    ...
    value: function loadSong() {
      ...
      this.audio.onloadedmetadata = function () {
        return _this3.f1('.time-end').innerText = _this3.formatTime(_this3.audio.duration);
      };
    ...
    value: function locateLyric() {
      ...
      if (currentTime > nextLineTime && this.lyricIndex < this.lyricsArr.length - 1) {
        this.lyricIndex++;
        var node = this.f1('[data-time="' + this.lyricsArr[this.lyricIndex][0] + '"]');
    ...
    value: function setLyricToCenter(node) {
      var translateY = node.offsetTop - this.f1('.panelLyrics').offsetHeight / 2;
      translateY = translateY > 0 ? translateY : 0;
      this.f1('.panelLyrics .container').style.transform = "translateY(-".concat(translateY, "px)");
      this.f2('.panelLyrics p').forEach(function (node) {
...
},{"./swiper":"src/javascript/swiper.js","../scss/index.scss":"src/scss/index.scss","./icon.js":"src/javascript/icon.js","./swiper.js":"src/javascript/swiper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
